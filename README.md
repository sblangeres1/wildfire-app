...
## Credits
This app was built collaboratively by Scott Blangeres (JavaScript, API), Abigail Queen (HTML, CSS), Truman Stephenson (JavaScript, API), Nicole Verhulp (HTML, CSS). Fire icon and image from [Flaticon.](https://flaticon.com) Code for responsive vertical menu built out from the source [Pure.css.](https://purecss.io/menus/). Header background from image at [Nature Conservancy.](https://www.nature.org/en-us/about-us/where-we-work/united-states/california/stories-in-california/californias-wildfire-future/)
